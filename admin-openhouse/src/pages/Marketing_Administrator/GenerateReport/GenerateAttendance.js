...
class GenerateAttendance extends Component {
    ...
    universityFiltered(){
        ...
        if(this.state.universityValue === "All") {
            ...
            db.collection("Attendance").where("universityName","==",this.state.universityValue)
            .onSnapshot((snapshot) => {
                const attendance = [];
                snapshot.forEach((doc) => {
                    const data = {
    ...
    talknameFiltered(){
        ...
        if (this.state.talkNameValue === "All") {
            ...
            db.collection("Attendance").where("talkName","==",this.state.talkNameValue)
            .onSnapshot((snapshot) => {
                const attendance = [];
                snapshot.forEach((doc) => {
                    getTalkName = doc.data().talkName
