                            ...
                            <Navbar bg="dark" className="sideNavBar-container">
                                <Nav defaultActiveKey="/MAHome" className="sideNavBar-content flex-column">
                                    <Nav.Item className="sideNavBar-navItems">
                                        <Nav.Link href="/AttendanceMarkingScanner" onClick={() => [localStorage.clear()]} className="sideNavBar-navLinks"><FontAwesomeIcon icon={faBars} id="sideNavBar-homeIcon" />Home</Nav.Link>
                                    </Nav.Item>
